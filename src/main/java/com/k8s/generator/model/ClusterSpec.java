...
public record ClusterSpec(
    ...
    public static class ClusterSpecBuilder {
        ...
        public ClusterSpecBuilder firstIp(String ipString) {
            ...
            IPAddressString ipAddr = new IPAddressString(ipString);
            if (!ipAddr.isValid()) {
    ...
    public ClusterSpec withCni(CniType newCni) {
        return new ClusterSpec(name, type, firstIp, masters, workers, sizeProfile, vms, newCni, podNetwork, svcNetwork);
    }
}
