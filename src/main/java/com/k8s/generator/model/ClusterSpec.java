 ...
 * <ul>
 *   <li><b>KIND</b>: masters=0, workers=0 (VMs generated as "cluster" role)</li>
 *   <li><b>MINIKUBE</b>: masters=0, workers=0 (VMs generated as "cluster" role)</li>
 *   <li><b>KUBEADM</b>: masters≥1, workers≥0 (full multi-node cluster)</li>
 *   <li><b>NONE</b>: masters=0, workers=0 (VMs generated as "management" role)</li>
 * </ul>
 *
 * <p>IP Allocation:
 * <ul>
 ...
 * );
 *
 * // Multi-node kubeadm cluster (explicit VMs)
 ...
 *     SizeProfile.LARGE,
 *     List.of(
 *         new VmConfig("master-1", "master", "192.168.56.20", SizeProfile.LARGE, Optional.empty(), Optional.empty()),
 *         new VmConfig("master-2", "master", "192.168.56.21", SizeProfile.LARGE, Optional.empty(), Optional.empty()),
 *         // ... more VMs
 *     )
 * );
 * }</pre>
...
public record ClusterSpec(
    ...
    public ClusterSpec withVms(List<VmConfig> newVms) {
        ...
        return new ClusterSpec(name, type, firstIp, masters, workers, sizeProfile, newVms);
    }
}